...
public abstract class ToInt<T> implements Function<T, Integer> {
	public abstract int convert(T value);
	...
	public static final ToInt<String> FROM_STRING = new ToInt<String>() {
		@Override
	...
	public static final ToInt<Integer> IDENTITY = new ToInt<Integer>() {
		@Override
